...
const AboutPage = () => (
  <Container className="py-5">
    ...
    <div className="text-center mb-5">
      ...
      <p className="fs-5 text-muted">Our mission, vision, and team behind your success.</p>
    </div>
      ...
      <Col lg={6}>
        ...
        <Card bg="success" text="white" className="p-2 mb-3" style={{ maxWidth: "720px" }}>
          <Card.Body className="p-2">
            <p className="m-0 fw-semibold">"We don't just help you navigate the system – we help you build your future."</p>
          </Card.Body>
        </Card>
      </Col>
      <Col lg={6}>
    ...
    <Row className="text-center g-4 mb-5">
      <Col md={4}>
        <div className="icon-box-fix bg-primary-dark-green text-white fs-4 mx-auto mb-3">
          <i className="bi bi-geo-alt"></i>
        </div>
        <h5 className="fw-bold text-primary-dark-green">Nationwide Support</h5>
        <p className="text-muted">Serving newcomers across all provinces</p>
      </Col>
      <Col md={4}>
        <div className="icon-box-fix bg-primary-dark-green text-white fs-4 mx-auto mb-3">
          <i className="bi bi-briefcase"></i>
        </div>
        <h5 className="fw-bold text-primary-dark-green">Expert Team</h5>
        <p className="text-muted">Certified and experienced professionals</p>
      </Col>
      <Col md={4}>
        <div className="icon-box-fix bg-primary-dark-green text-white fs-4 mx-auto mb-3">
          <i className="bi bi-building"></i>
        </div>
        <h5 className="fw-bold text-primary-dark-green">Integrated Approach</h5>
        <p className="text-muted">Seamless coordination between services</p>
      </Col>
    </Row>
      ...
      <Row xs={1} md={2} lg={4} className="g-4">
        {[ 
          ...
          <Col key={i}>
            ...
            <h5 className="fw-bold text-primary-dark-green mb-1">{m.name}</h5>
            <p className="text-success fw-semibold mb-2">{m.role}</p>
            <p className="text-muted small">{m.expertise}</p>
          </Col>
        ))}
      </Row>
    </Card>
